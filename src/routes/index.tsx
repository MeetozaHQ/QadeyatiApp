...
function LandingPage() {
  ...
  const faqs = [
    ...
    {
      q: "ماذا يحدث لحسابي وقضاياي ومستنداتي إذا توقفت عن تجديد الاشتراك المدفوع؟",
      a: "عند انتهاء اشتراكك وعدم التجديد، فإننا نطبق سياسة ذكية ومرنة تراعي مصلحة عملك: (1) يظل ملفك الشخصي (البروفايل المهني) نشطاً ومتاحاً للجميع بشكل طبيعي. (2) يظل بإمكانك تسجيل الدخول وعرض وتصفح قضاياك السابقة وجلساتك وملفاتك الحالية بحرية تامة (وضع القراءة فقط). (3) يتم تقييد ميزة الربط والرفع المباشر عبر Google Drive وتصبح غير نشطة (Dimmed). (4) يتوقف استخدام المستشار الذكي، ويتم تعطيل إمكانية إضافة قضايا أو جلسات جديدة. (5) للتوفير في تكاليف الاستضافة السحابية المكلفة، تصبح المستندات المرفوعة معطلة (Dimmed) ويحق للمنصة حذفها نهائياً بعد مرور 90 يوماً متواصلة من عدم السداد، حيث نرسل لك رسائل بريدية تذكيرية تنبيهية تلقائياً في الأيام 30 و 60 و 80 لتطلب منك إنقاذ ملفاتك أو تجديد الاشتراك قبل الحذف. (6) استكمل أعمالك المالية العالقة! يمكنك الاستمرار في متابعة أقساط الموكلين واستكمال الإجراءات المالية المسجلة بالفعل وتحصيل ديون مكتبك دون عوائق.",
    },
  ];
                ...
                <div className="border-t border-slate-900/60 pt-5 space-y-3">
                  ...
                  <ul className="space-y-2.5 text-xs text-slate-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        إدارة حتى <strong>قضيتين (٢)</strong> كحد أقصى
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="h-3.5 w-3.5 text-slate-400 shrink-0 mt-0.5" />
                      <span>
                        <strong>٥ محادثات</strong> للمستشار الذكي شهرياً
                      </span>
                    </li>
