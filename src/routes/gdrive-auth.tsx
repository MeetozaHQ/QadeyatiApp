...
export function GDriveAuthPage() {
  ...
  // Automatically trigger on load since it is opened inside a popup
  useEffect(() => {
    // We can auto-trigger because the user clicked the button on the parent page to open this popup
    startAuth();
  }, []);
