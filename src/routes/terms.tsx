        ...
        <div className="space-y-8 rounded-2xl sm:rounded-3xl border border-border/40 bg-[#0d121f]/40 p-4 sm:p-8 md:p-10 shadow-xl backdrop-blur-sm">
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-amber-400 leading-relaxed bg-amber-500/5 p-3 rounded-lg border border-amber-500/10">
              <strong>تنبيه هام بشأن التوقف عن الدفع وحذف الملفات:</strong> في حال توقف الحساب عن
              الدفع لأكثر من 90 يوماً متواصلة، يحق للمنصة حذف الملفات المرفوعة نهائياً لتوفير مساحة
              الاستضافة، مع إرسال رسائل بريدية تذكيرية آلية (مثلاً بعد 30، 60، و80 يوماً) لتنبيهه
              ومطالبته بإنقاذ ملفاته عبر تجديد الاشتراك.
            </p>
          </section>
